...
import { quizAttemptHistoryQuerySchema, listWorkspaceQuizAttempts } from '@/domains/quizzes';
...
export async function GET(request: NextRequest, context: RouteContext): Promise<Response> {
  try {
    ...
    const attempts = await listWorkspaceQuizAttempts(workspaceId, user.uid, query.limit);
