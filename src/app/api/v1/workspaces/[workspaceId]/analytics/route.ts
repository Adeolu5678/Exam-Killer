...
import { analyticsDaysQuerySchema, getWorkspaceAnalyticsSummary } from '@/domains/analytics';
...
export async function GET(request: NextRequest, context: RouteContext): Promise<Response> {
  try {
    ...
    const summary = await getWorkspaceAnalyticsSummary(workspaceId, user.uid, days);
